...
exports.readSystemFile = exports.outputCacheFile = exports.readCacheFile = exports.rmCache = exports.listCacheDir = exports.statLocalFile = exports.chmodLocalFile = exports.findUpLocal = exports.localPathIsFile = exports.createCacheWriteStream = exports.readLocalDirectory = exports.findLocalSiblingOrParent = exports.localPathExists = exports.privateCacheDir = exports.ensureCacheDir = exports.ensureLocalDir = exports.ensureDir = exports.renameLocalFile = exports.deleteLocalFile = exports.writeLocalFile = exports.readLocalFile = exports.getSiblingFileName = exports.getParentDir = exports.pipeline = void 0;
...
async function readLocalFile(fileName, encoding) {
    const localFileName = (0, util_2.ensureLocalPath)(fileName);
    try {
...
async function renameLocalFile(fromFile, toFile) {
    const fromPath = (0, util_2.ensureLocalPath)(fromFile);
    const toPath = (0, util_2.ensureLocalPath)(toFile);
...
async function localPathExists(pathName) {
    ...
    const path = (0, util_2.ensureLocalPath)(pathName);
    try {
...
async function readLocalDirectory(path) {
    const localPath = (0, util_2.ensureLocalPath)(path);
...
function createCacheWriteStream(path) {
    const fullPath = (0, util_2.ensureCachePath)(path);
...
function chmodLocalFile(fileName, mode) {
    const fullFileName = (0, util_2.ensureLocalPath)(fileName);
...
function readCacheFile(fileName, encoding) {
    const fullPath = (0, util_2.ensureCachePath)(fileName);
...
function outputCacheFile(file, data) {
    const filePath = (0, util_2.ensureCachePath)(file);
